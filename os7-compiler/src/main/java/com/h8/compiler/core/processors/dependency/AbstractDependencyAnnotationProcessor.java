...
class AbstractDependencyAnnotationProcessor<T extends Annotation> extends AbstractProcessor {
    AbstractDependencyAnnotationProcessor(CompilationContext context, Class<T> c) {
        super(context);
